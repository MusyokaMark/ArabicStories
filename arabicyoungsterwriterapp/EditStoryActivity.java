...
public class EditStoryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        etParagraph.setText(model.getPara());

        if (model.getAudio().equals("null")) {
            ivAudio.setColorFilter(R.color.black);
        } else {
            audioUrl = model.getAudio();
            ivAudio.setColorFilter(R.color.green);
        }

        etTitle.setTextColor(Color.parseColor(model.getTvColor()));
        etParagraph.setTextColor(Color.parseColor(model.getTvColor()));
        llMain.setBackgroundColor(Color.parseColor(model.getBgColor()));

        if (model.getImage().equals("null")) {

            ivPicture.setColorFilter(R.color.black);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot dataSnapshot) {
                ...
                if (doOnce) {
                    ...
                    isUploaded = true;
                    Toast.makeText(EditStoryActivity.this, "Upload Your Story Successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(EditStoryActivity.this, MainActivity.class));
                    finish();
            ...
            public void onCancelled(@NonNull @NotNull DatabaseError error) {
                Toast.makeText(EditStoryActivity.this, "Something wrong", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void deleteTitleAndParagraph() {
        ...
        startActivity(new Intent(EditStoryActivity.this, CreateStoryActivity.class));
        finish();
    ...
    private void cancelStory() {
        ...
        startActivity(new Intent(EditStoryActivity.this, HomeActivity.class));
        finish();
    }

    private void template() {

        startActivity(new Intent(EditStoryActivity.this, TemplateActivity.class));
    }
        ...
        switch (id) {
            case R.id.actionTvColor:
                ...
                new ColorPickerDialog
                        .Builder(EditStoryActivity.this)
                        .setTitle("Pick Theme")
    ...
    private void uploadImageToFirebase(Uri uri) {
        ...
        if (EditStoryActivity.this.etTitle.getText().toString().matches("") || EditStoryActivity.this.etParagraph.getText().toString().matches("") && picUri == null) {
            Configs.simpleAlert("Make sure you've typed a Title, a first paragraph and uploaded a cover image!", EditStoryActivity.this);
            alertDialog.dismiss();
            return;
        }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                childRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(EditStoryActivity.this, "upload successfully", Toast.LENGTH_SHORT).show();
                    }
                });
